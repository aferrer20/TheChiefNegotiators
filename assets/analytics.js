/* The Chief Negotiators — analytics loader.
   ...
   Nothing below runs until cookie consent is granted — see assets/consent.js.
...
(function () {
  ...
  window.tcnInitAnalytics = init;

  try {
    if (window.localStorage && localStorage.getItem('tcn_consent') === 'granted') {
      init();
    }
  } catch (e) {}
})();
